...
const Questionnaire = () => {
    ...
    const submit = async () => {
        ...
        // If any question is missing, prevent submit
        ...
        await submitQuestionnaire({ content: answers }, token);
        navigate("/user");
    };
    ...
    return (
        <div className="card">
            ...
            <div className={`question-block ${errors.atmosphere ? "error" : ""}`}>
                <p className="question">
                    <strong>What kind of group atmosphere feels most comfortable to you? (Choose one)</strong>
                </p>
            ...
            <div className={`question-block ${errors.communication ? "error" : ""}`}>
                <p className="question">
                    <strong>How do you prefer to communicate? (Choose one)</strong>
                </p>
